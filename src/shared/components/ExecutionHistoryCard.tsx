...
export function ExecutionHistoryCard({ execution, onSelect }: ExecutionHistoryCardProps) {
  return (
    <button aria-label={execution.routineTitle} className="account-page__card" onClick={() => onSelect(execution)} type="button">
      <div className="account-page__card-body">
        <div className="account-page__card-header">
          ...
          <span className="account-page__card-date">{new Date(execution.postedAt).toLocaleDateString('ja-JP')}</span>
        </div>

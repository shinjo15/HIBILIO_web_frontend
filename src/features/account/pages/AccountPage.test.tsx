...
const service: AccountService = {
  ...
  listExecutionHistories: async () => [{ achievedActions: 2, completed: true, executedAtLabel: '今日', id: 'execution-1', minutes: 30, routineId: 'routine-1', routineTitle: '朝の集中ルーティン', totalActions: 2 }],
